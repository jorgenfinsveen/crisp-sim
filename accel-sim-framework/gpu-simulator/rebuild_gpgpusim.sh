...
#(cd "$ACCEL_SIM/gpu-simulator" && source setup_environment.sh)
#(source "$ACCEL_SIM/gpu-simulator/setup_environment.sh" && cd "$ACCEL_SIM" && make -j -C ./gpu-simulator gpgpu-sim)
